...
if (selected == 'Analisa Data Kimia Organik'):
   ...
   st.write('* Uji Positif = Terdapat gugus hidroksil berupa alkohol dalam sampel')
   st.write('* Uji Negatif = Tidak terdapat gugus hidroksil berupa alkohol dalam sampel')   
